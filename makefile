CC = g++
OBJS = main.o parser.o lexeme.o printer.o
OOPTS = -Wall -Wextra -g -c -std=c++11
LOPTS = -Wall -Wextra -g -std=c++11 	

all : main

main : main.o printer.o evaluator.o ztdLib.o parser.o lexer.o lexeme.o type.h
	g++ $(LOPTS) main.o evaluator.o ztdLib.o printer.o parser.o lexer.o lexeme.o -o zLang
...
printer.o : printer.cpp printer.h lexeme.h
	g++ $(OOPTS) printer.cpp
